...
def OneDetector( detectorLength, phantomLength, detectorMaterial, nevents, Emin, Emax,  simulationWindow=1E-3, coincidenceWindow=4.7E-9 ):
    ...
    tracerData = CreateDataset( detectorLength, "Panorama", phantomLength, "LinearF18", nevents, Emin, Emax, detectorMaterial )
    crystalData = None
    ...
    if detectorMaterial == "LSO" or detectorMaterial == "LYSO" :
        ...
        crystalData = CreateDataset( detectorLength, "Panorama", phantomLength, "LinearF18", nevents, Emin, Emax, detectorMaterial )

    activityAtTimePanorama, necrAtTimePanorama, trueAtTimePanorama, rPlusSAtTimePanorama = NECRatTimeF18( tracerData, crystalData, crystalActivity, pp.DetectorRadius(), phantomLength, detectorMaterial, simulationWindow, coincidenceWindow )
    return ( max( necrAtTimePanorama ), pp.DetectorDiscreteLength( detectorLength ) )
