...
OmniLegendParameterisationPanels::OmniLegendParameterisationPanels( G4int nCopies )
{
...
void OmniLegendParameterisationPanels::ComputeTransformation( const G4int copyNo, G4VPhysicalVolume* physVol ) const
{
  if ( copyNo >= ( G4int )m_positions.size() )
  {
    G4cerr << "Unknown copyNo for OmniLegendParameterisationPanels: " << copyNo << G4endl;
    return;
  }
