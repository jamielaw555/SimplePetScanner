...
UmiPanoramaParameterisationPanels::UmiPanoramaParameterisationPanels( G4int nCopies )
{
...
void UmiPanoramaParameterisationPanels::ComputeTransformation( const G4int copyNo, G4VPhysicalVolume* physVol ) const
{
  if ( copyNo >= ( G4int )m_positions.size() )
  {
    G4cerr << "Unknown copyNo for UmiPanoramaParameterisationPanels: " << copyNo << G4endl;
    return;
  }
